 ...
 */
public class FactorGenerator implements Iterator<BigInteger>, Iterable<BigInteger> {
    ...
    /** */
    public FactorGenerator(BigInteger n0) {
        BigInteger n = n0, d, q;
        int w = 0;
    ...
    /** */
    private Iterator<BigInteger> inner;

    @Override
    public boolean hasNext() {
        if (inner == null) {
            inner = factors.iterator();
        }
